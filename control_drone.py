...
def cmd_velocity_test(args: argparse.Namespace) -> int:
    ...
    try:
        with DroneController(
            ...
            # 2. Sende Geschwindigkeitsbefehle im Loop (ca. 5 Hz)
            ...
            # 3. Bewegung stoppen vor der Landung
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=921600,
        help="Baudrate der seriellen Schnittstelle (Standard: 921600 für Pi UART).",
    )
    parser.add_argument(
        "--takeoff-alt",
        type=float,
