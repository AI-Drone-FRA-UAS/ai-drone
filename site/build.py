...
PAGES: list[Page] = [
    ...
    Page(
        ...
        lead="BCM12-Servo, Stromversorgung und Grenzen der aktuellen Nachweise.",
    ),
    Page(
        slug="rahmen",
    ...
    Page(
        ...
        lead="Der begrenzte GuidedNoGPS-/Loiter-Testablauf und seine Voraussetzungen.",
    ),
    Page(
        slug="verbindung",
        ...
        lead="FC-USB, Pi-Verbindung und disarmierte Inspektion.",
    ),
    Page(
        slug="readme",
    ...
    Page(
        slug="eduroam",
        title="Raspberry-Pi-Netzwerk",
        source="docs/pi-networking.md",
        group="Raspberry Pi",
        nav_title="Pi-Netzwerk",
        lead="Tailscale, Campus-WLAN und der eigene Hotspot als Rückfallebene.",
    ),
    Page(
        slug="hotspot",
    ...
    Page(
        ...
        in_nav=False,
        lead="Aktuelle Servo-Dokumentation; ältere Arduino-Versuche sind archiviert.",
    ),
    Page(
        slug="doku-index",
...
EXTRA_LINKS: dict[str, str] = {
    ...
    "docs/pi-networking.md": "eduroam.html",
    "docs/PAYLOAD_DROP.md": "abwurf.html",
}
