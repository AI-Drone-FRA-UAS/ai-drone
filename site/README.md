...
and the repository root into a static website — the operational Markdown remains the maintained source. Four hand-written
presentation pages are updated separately and label historical measurements.
...
- **Links.** Links between Markdown files are rewritten to the matching page of
  ...
  `hardware/3d-prints/`, a script — becomes a link to that file on GitHub, so nothing
  dead-ends.
