...
## 1. What is in `hardware/3d-prints/`
...
The pieces above are the enclosure and the soft frame parts. The August design record left the mounting plate open. Compare the current
assembly against the newest hardware capture; the mount has to hold:
